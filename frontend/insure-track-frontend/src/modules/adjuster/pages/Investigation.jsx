            ...
            <div className="divide-y divide-gray-50 max-h-[600px] overflow-y-auto">
              {claims.map(c => (
                <button key={c.claimId} onClick={() => selectClaim(c)}
                  className={`w-full text-left px-4 py-3.5 transition-colors ${selected?.claimId === c.claimId ? "bg-blue-50 border-l-4 border-l-blue-600" : "hover:bg-gray-50"
                    }`}>
              ...
              <div className="bg-white rounded-xl border border-gray-200 shadow-sm p-5">
                ...
                <div className="space-y-2">
                  <button onClick={handleApprove} disabled={loading}
                    className={`w-full flex items-center justify-center gap-2 py-2.5 rounded-lg text-sm font-medium transition-colors ${assignment
