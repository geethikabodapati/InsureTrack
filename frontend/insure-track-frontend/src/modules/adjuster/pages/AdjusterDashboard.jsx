                  ...
                  return (
                    <div key={step.status} className="flex items-center flex-1">
                      <div className="flex-1 text-center">
                        <div className={`w-8 h-8 rounded-full mx-auto flex items-center justify-center text-xs font-bold ${isActive ? `${step.color} text-white ring-4 ring-offset-2 ring-blue-200` :
