    ...
    return (
        <Router>
            <Routes>
                ...
                <Route path="/underwriter-dashboard" element={<Layout />}>
                ...
                {/*Analyst*/}
                <Route path="/billing-dashboard" element={token ? <BillingDashboard/> : <Navigate to="/"/>}/>
        <Route path="/payments-dashboard" element={token ? <PaymentsDashboard/> : <Navigate to="/"/>}/>
        <Route path="/claims-dashboard" element={token ? <ClaimsDashboard/> : <Navigate to="/"/>}/>
        <Route path="/refund-dashboard" element={token ? <RefundDashboard/> : <Navigate to="/"/>}/>
        ...
        <Route element={token ? <AdminLayout /> : <Navigate to="/login" />}>
                ...
                <Route
                path="/agent"
                element={token ?<AgentLayout/> : <Navigate to="/auth/login" />}
            >
