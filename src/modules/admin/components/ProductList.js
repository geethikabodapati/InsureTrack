...
// import { Plus, MoreVertical, X, Search, ShieldPlus, Calculator } from 'lucide-react'; 
...
//                     <h1>Products</h1>
//                     <p>Manage your insurance products and offerings</p>
//                 </div>
...
//                 {error ? (
//                     <div className="error-box"><strong>{error}</strong></div>
//                 ) : (
...
//                                         <td style={{ fontWeight: '600' }}>PRD-00{product.productId}</td>
//                                         <td>{product.name}</td>
...
//             {/* PRODUCT MODAL - Mapped to ObjectType Enum */}
//             {isProductModalOpen && (
...
//             {/* COVERAGE MODAL - Mapped to CoverageType Enum */}
//             {isCoverageModalOpen && (
//                 <div className="modal-overlay">
//                     <div className="modal-content">
//                         <div className="modal-header">
//                             <h2>Add Coverage (Product ID: {selectedProductId})</h2>
...
//                                 <button type="submit" className="btn-confirm">Save to DB</button>
//                             </div>
//                         </form>
//                     </div>
//                 </div>
...
//             {/* RATING RULE MODAL - Added Age/Location/VehicleType options */}
//             {isRuleModalOpen && (
//                 <div className="modal-overlay">
//                     <div className="modal-content">
//                         <div className="modal-header">
//                             <h2>Add Rating Rule (Product ID: {selectedProductId})</h2>
...
//                                 <input 
//                                     type="text" 
//                                     placeholder="e.g. basePremium * 1.2" 
